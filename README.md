This is a distributed page rank algorithm using Apache spark and data from: SNAP https://snap.stanford.edu/data/ Data can be downloaded there (must be directed graph)
